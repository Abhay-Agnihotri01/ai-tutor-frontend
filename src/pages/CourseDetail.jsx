...
const CourseDetail = () => {
  ...
  const fetchRatings = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/ratings/course/${id}?limit=5`);
            ...
            <div className="mb-8">
              <div className="relative bg-gray-900 rounded-lg overflow-hidden aspect-video">
                {course.chapters?.[0]?.videos?.[0] ? (
                  ...
                  <>
                    <img
                      src={course.thumbnail ? (course.thumbnail.startsWith('http') ? course.thumbnail : `${BASE_URL}${course.thumbnail}`) : 'https://via.placeholder.com/400x225/6366f1/ffffff?text=Course'}
                      alt={course.title}
                  ...
                  <img
                    src={
                      course.instructor.avatar && course.instructor.avatar.startsWith('http')
                        ...
                        : course.instructor.avatar
                          ? `${BASE_URL}${course.instructor.avatar}`
                ...
                {isEnrolled ? (
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center space-x-2 p-3 rounded-lg border transition-all duration-200 ${inWishlist
