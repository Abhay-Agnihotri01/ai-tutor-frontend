...
const TextLectureNotes = ({ textLectureId, courseId, inline = false, onClose }) => {
  ...
  const loadNotes = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/notes/text-lecture/${textLectureId}`, {
  ...
  const loadBookmarks = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/bookmarks/text-lecture/${textLectureId}`, {
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const saveNote = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${API_URL}/notes/text-lecture`, {
        method: 'POST',
        headers: {
  ...
  const saveBookmark = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${API_URL}/bookmarks/text-lecture`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const deleteNote = async (noteId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${API_URL}/notes/text-lecture/${noteId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const deleteBookmark = async (bookmarkId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${API_URL}/bookmarks/text-lecture/${bookmarkId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
